...
const Dashboard = () => {
  ...
  <button onClick={() => toggleFullscreen(comp.id)} className="p-2 rounded-full transition-colors">
    {isFullscreen ? (
  ...
  {!isFullscreen && (
    <button onClick={() => handleRemoveComponent(comp.id)} className="p-2 hover:bg-red-100 rounded-full transition-colors">
